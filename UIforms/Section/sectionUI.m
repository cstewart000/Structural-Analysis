function varargout = sectionUI(varargin)
...
% Last Modified by GUIDE v2.5 30-Jun-2015 12:38:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @sectionUI_OpeningFcn, ...
                   'gui_OutputFcn',  @sectionUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function sectionUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = sectionUI_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pb_add_section.
function pb_add_section_Callback(hObject, eventdata, handles)
% hObject    handle to pb_add_section (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pd_delete_section.
function pd_delete_section_Callback(hObject, eventdata, handles)
% hObject    handle to pd_delete_section (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
data = get(handles.uitable1, 'data');
