function varargout = nodeLoadsUI(varargin)
...
% Last Modified by GUIDE v2.5 02-Jul-2015 11:10:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @nodeLoadsUI_OpeningFcn, ...
                   'gui_OutputFcn',  @nodeLoadsUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function nodeLoadsUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
%% Creation code
if(exist('nodeLoadData.mat'))
    load('nodeLoadData.mat')
    if(exist('nodeLoadData'))
        data = nodeLoadData;
    ...
    set(handles.uitable1, 'data', data);
    nodeLoadData = data;
    save('nodeLoadData.mat', 'nodeLoadData');
end

% --- Outputs from this function are returned to the command line.
function varargout = nodeLoadsUI_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pb_add_load.
function pb_add_load_Callback(hObject, eventdata, handles)
% hObject    handle to pb_add_load (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
data = get(handles.uitable1, 'data');
...
% --- Executes on button press in pd_delete_load.
function pd_delete_load_Callback(hObject, eventdata, handles)
% hObject    handle to pd_delete_load (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
data = get(handles.uitable1, 'data');
