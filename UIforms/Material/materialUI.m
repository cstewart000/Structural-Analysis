function varargout = materialUI(varargin)
...
% Last Modified by GUIDE v2.5 30-Jun-2015 12:45:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @materialUI_OpeningFcn, ...
                   'gui_OutputFcn',  @materialUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function materialUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = materialUI_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pb_add_material.
function pb_add_material_Callback(hObject, eventdata, handles)
% hObject    handle to pb_add_material (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pd_delete_material.
function pd_delete_material_Callback(hObject, eventdata, handles)
% hObject    handle to pd_delete_material (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
data = get(handles.uitable1, 'data');
