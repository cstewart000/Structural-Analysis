function varargout = memberUI(varargin)
...
% Last Modified by GUIDE v2.5 30-Jun-2015 12:06:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @memberUI_OpeningFcn, ...
                   'gui_OutputFcn',  @memberUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function memberUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = memberUI_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pb_add_member.
function pb_add_member_Callback(hObject, eventdata, handles)
% hObject    handle to pb_add_member (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pd_delete_member.
function pd_delete_member_Callback(hObject, eventdata, handles)
% hObject    handle to pd_delete_member (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
data = get(handles.uitable1, 'data');
